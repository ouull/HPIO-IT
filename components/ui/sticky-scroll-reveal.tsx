...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      className="relative flex h-[35rem] w-full items-start justify-center space-x-12 overflow-y-auto p-10 rounded-3xl shadow-2xl border border-white/5 scrollbar-hide"
      ref={ref}
    >
          ...
          {content.map((item, index) => (
            <div key={item.title + index} className="my-32">
              <motion.h2
                ...
                className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-6 leading-snug"
              >
                {item.title}
              </motion.h2>
              <motion.p
